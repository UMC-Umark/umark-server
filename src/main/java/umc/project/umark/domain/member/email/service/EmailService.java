package umc.project.umark.domain.member.email.service;
...
import umc.project.umark.domain.member.email.repository.EmailCodeRepository;
...
public class EmailService {
    ...
    public String joinEmail(String email) {
        ...
        String content =
                "Umark를 방문해주셔서 감사합니다." + 	//html 형식으로 작성 !
                        "<br><br>" +
                        "인증 번호는 " + code + "입니다." +
                        "<br>" +
    ...
    public void checkCode(String email,String code){
        EmailCode foundCode = emailCodeRepository.findByCode(code);
        String savedEmail = foundCode.getEmail();
        if((foundCode == null) || (!savedEmail.equals(email))){
            throw new GlobalException(GlobalErrorCode.NOT_MATCH_CODE);
        }
